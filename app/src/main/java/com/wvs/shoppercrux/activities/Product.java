...
//        recyclerViewlayoutManager = new LinearLayoutManager(this);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        MenuItemCompat.setActionView(mCart,R.layout.menu_badge);
        RelativeLayout badge = (RelativeLayout) MenuItemCompat.getActionView(mCart);
        TextView tv = (TextView) badge.findViewById(R.id.actionbar_notifcation_textview);
        tv.setText("12");
